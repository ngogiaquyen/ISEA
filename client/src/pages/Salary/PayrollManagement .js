...
const PayrollManagement = () => {
  const [payrollData, setPayrollData] = useState([
    { id: 1, name: "Nguyễn Văn A", position: "Developer", salary: 20000000, bonus: 2000000, month: "01/2024", bhxh: 1000000, bhyt: 500000, tncn: 1500000 },
    { id: 2, name: "Trần Thị B", position: "Designer", salary: 18000000, bonus: 1500000, month: "01/2024", bhxh: 900000, bhyt: 400000, tncn: 1300000 },
    { id: 3, name: "Lê Văn C", position: "Manager", salary: 25000000, bonus: 5000000, month: "01/2024", bhxh: 1250000, bhyt: 600000, tncn: 2000000 },
    { id: 4, name: "Nguyễn Văn D", position: "HR", salary: 15000000, bonus: 1000000, month: "02/2024", bhxh: 750000, bhyt: 350000, tncn: 1000000 },
    { id: 5, name: "Phạm Thị E", position: "Accountant", salary: 17000000, bonus: 1200000, month: "02/2024", bhxh: 850000, bhyt: 400000, tncn: 1100000 },
  ]);
    ...
    <div className={cx("wrapper")}>
      ...
      <div className={cx("filter-container")}>
        <div>
          ...
          <select value={selectedMonth} onChange={(e) => setSelectedMonth(e.target.value)} className={cx("filter-select")}>
            {months.map((month) => (
        ...
        <div>
          ...
          <input type="text" value={searchName} onChange={(e) => setSearchName(e.target.value)} placeholder="Nhập tên nhân viên..." className={cx("search-input")} />
        </div>
      </div>
      <div className={cx("button-container")}>
        <button onClick={handleDownloadExcel} className={cx("download-button")}>Tải Xuống Excel</button>
      </div>
