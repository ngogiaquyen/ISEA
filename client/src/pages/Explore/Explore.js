        ...
        <div className={cx('col1')}>
          <div className={cx('box-info', 'col1-wrapper', { init: loading })}>
            ...
            <div className={cx('main-info-content')}>
              ...
              dạy cao cấp trên toàn quốc.
              <br />
              <br />
              Trụ sở chính: Phòng 103, Tầng 1 - Toà C5, Trường Đại học Công nghệ Thông tin và Truyền thông Thái Nguyên,
            ...
            <div className={cx('com-contact-info')}>
              <div className={cx('com-contact-address')}>
                ...
                <span className={cx('address-content')}>
                  Phòng 103, Tầng 1 - Toà C5, Trường Đại học Công nghệ Thông tin và Truyền thông Thái Nguyên, Tân Thịnh,
